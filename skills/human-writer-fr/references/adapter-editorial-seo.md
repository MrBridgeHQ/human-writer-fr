...
Priority ranking, applied on top of the language adapter (`tells-stylistic-fr.md`):
...
- `tells-stylistic-fr.md`: language-specific vocabulary and construction tells
