...
> Doctrine for the `human-writer` skill, applied to short-form comms: emails, LinkedIn posts and DMs, Slack/Teams messages to clients, X/Twitter replies, GitHub issue comments, customer replies. Loaded in addition to language-specific stylistic tells (`tells-stylistic-fr.md`).
...
- [ ] No tier-1 AI vocab (see `tells-stylistic-fr.md`)
...
- `tells-stylistic-fr.md`: full vocabulary and construction lists to avoid
