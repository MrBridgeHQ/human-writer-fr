...
Cross-reference `tells-stylistic-fr.md` for the vocabulary side. This file flags it as a *structural* tell because the section itself — its presence, placement, and H2 — is the signal.
...
- `tells-stylistic-fr.md` — vocabulary side (lexical tells, banned-word lists)
